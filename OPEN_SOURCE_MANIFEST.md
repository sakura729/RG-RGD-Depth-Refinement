...
- `configs/void_paper_command.txt`: VOID reproduction command.
- `configs/selfsup_paper_command.txt`: RGB-D/IMU reproduction command.
...
- `scripts/verify_release.py`: synthetic end-to-end release verification for both training entry points.
